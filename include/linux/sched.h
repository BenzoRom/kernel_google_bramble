...
static inline int register_cpu_cycle_counter_cb(struct cpu_cycle_counter_cb *cb) { return 0; }
static inline void sched_exit(struct task_struct *p) { }
static inline void sched_update_cpu_freq_min_max(const cpumask_t *cpus,
					u32 fmin, u32 fmax) { }
static inline void sched_set_refresh_rate(enum fps fps) { }
static inline int set_task_boost(int boost, u64 period) { return -EINVAL; }
DECLARE_PER_CPU_READ_MOSTLY(int, sched_load_boost);
/* --- End of WALT Scheduler stubs --- */
